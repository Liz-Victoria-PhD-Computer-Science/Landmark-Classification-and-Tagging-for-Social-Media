...
def valid_one_epoch(valid_dataloader, model, loss):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (data, target) in tqdm(
            ...
            # Calculate average validation loss (batch_idx + 1 to avoid division by zero)
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False):
    ...
    # YOUR CODE HERE
    scheduler  = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, min_lr=0.0001, patience=4, verbose=True)
